...
const colorPalettes = {
    ...
    '목요일': { dividend: '#FFE0B2', highlight: '#FF6D00', lineDividend: '#5f5f5f', prevPrice: '#212121', currentPrice: '#FF6D00' },
    '금요일': { dividend: '#F8BBD0', highlight: '#E91E63', lineDividend: '#5f5f5f', prevPrice: '#212121', currentPrice: '#E91E63' },
    
    'default': { dividend: '#BDBDBD', highlight: '#757575', lineDividend: '#5f5f5f', prevPrice: '#212121', currentPrice: '#757575' } // 기본값은 무채색으로 변경    'default': { dividend: '#fdc92dff', highlight: '#FB8C00', lineDividend: '#5f5f5f', prevPrice: '#212121', currentPrice: '#212121' }
};
