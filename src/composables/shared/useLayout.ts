 ...
 * 표면 색상 팔레트 (0 포함)
 */
export interface SurfacePalette extends ColorPalette {
    0: string;
}
 ...
 * 저장된 설정 불러오기
 */
const getSavedConfig = (): LayoutConfig | null => {
    try {
...
const appState = ref<LayoutConfig>({
...
const surfaces = ref<SurfaceDefinition[]>([
    {
        name: 'slate',
        palette: {
            0: '#ffffff',
